...
public class Language extends TableImpl<LanguageRecord> {
    ...
    private static final long serialVersionUID = -1796794471;
     ...
     */
    public final TableField<LanguageRecord, String> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.language.name</code>.
     */
    public final TableField<LanguageRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.language.spoken_by</code>.
     */
    public final TableField<LanguageRecord, String> SPOKEN_BY = createField(DSL.name("spoken_by"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

    /**
     * The column <code>public.language.category_id</code>.
     */
    public final TableField<LanguageRecord, String> CATEGORY_ID = createField(DSL.name("category_id"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
    ...
    public List<ForeignKey<LanguageRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<LanguageRecord, ?>>asList(Keys.LANGUAGE__LANGUAGE_CATEGORY_ID_FKEY);
    }

    public LanguageCategory languageCategory() {
        return new LanguageCategory(this, Keys.LANGUAGE__LANGUAGE_CATEGORY_ID_FKEY);
    }
